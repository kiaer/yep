...
matplot(lon.pts[1:20],test2,type="l",xlab="Longitude [degrees]",ylab=expression(paste("",Delta, "SST [",~degree~C,"]")),cex.lab=1.5,lwd=1.5)
...
matplot(lon.pts[1:20],test2sel,type="l",xlab="Longitude [degrees]",ylab=expression(paste("",Delta, "SST [",~degree~C,"]")),cex.lab=1.5,lwd=2)

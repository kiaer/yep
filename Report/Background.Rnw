...
The extracted data, nest records, was used to calculate the population numbers. How the calculations are made is shown in table \ref{tab:demodata}. 
...
\end{table}
%
\textcolor{red}{Figure 4 from article}. 

XXXXXXXXXXXXXXXXX
Tekst der støtter op om figuren 

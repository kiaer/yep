...
\caption{High resolution 0.05$^\circ\times 0.05^\circ$ gridpoint March-June anomalies in 1985 in the region of interest. The timeseries of March-June anomalies from 1985 to 2014 is used to compute the correlation map.}
\label{fig:SSTanom}
\end{figure}

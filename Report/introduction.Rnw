...
Demonstrate a basic understanding of how physics affects biology.
Extract and assess satellite data in order to address questions of climate change and its impacts on biological organisms.
Gain the ability to reproduce results and critically assess scientific literature
